...
function Header()
{
    ...
    $this->SetFont('Times','',12);
    $this->Cell(20,10,utf8_decode('Pago Bullet'),0,0,'R');
    // Salto de línea
    $this->Ln(20);
}
...
$pdf->Cell(2);
$pdf->Cell(180,30,utf8_decode('Tabla de amortización de pago tipo Bullet'),0,1,'C');
//////////////////////////////////////////////
...
$pdf->Cell(35,10,utf8_decode('Intereses'),1,0,'C');
$pdf->Cell(52,10,utf8_decode('Pago al final del período'),1,0,'C');
$pdf->Cell(52,10,utf8_decode('Deuda después del pago'),1,1,'C');
//////////////////////////////////////////////
...
for($j=1;$j<sizeof($arreglo["pagoCadaPeriodo"]);$j++)
{
    ...
    $pdf->SetTextColor(0,0,0);
    $pdf->Cell(2);
    $pdf->Cell(20,10,utf8_decode($arreglo["pagoCadaPeriodo"][$j]["periodo"]),1,0,'C');
    $pdf->Cell(25,10,utf8_decode($arreglo["fechas"][$j-1]),1,0,'C');
    $pdf->Cell(35,10,utf8_decode('$'.number_format($arreglo["pagoCadaPeriodo"][$j]["intereses"],2)),1,0,'R');
    $pdf->Cell(52,10,utf8_decode('$'.number_format($arreglo["pagoCadaPeriodo"][$j]["pagoFinalPeriodo"],2)),1,0,'R');
    $pdf->Cell(52,10,utf8_decode('$'.number_format($arreglo["pagoCadaPeriodo"][$j]["deudaDespuesPago"],2)),1,1,'R');
...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(2);
$pdf->Cell(47,10,utf8_decode('Fecha de liquidación'),1,0,'C');
$pdf->Cell(46,10,utf8_decode('Total de intereses'),1,0,'C');
$pdf->Cell(46,10,utf8_decode('Pago principal'),1,0,'C');
$pdf->Cell(46,10,utf8_decode('Total'),1,1,'C');

$pdf->SetFont('Times','',12);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(2);
$pdf->Cell(47,10,utf8_decode($arreglo["fechas"][sizeof($arreglo["fechas"])-1]),1,0,'C');
$pdf->Cell(46,10,utf8_decode('$'.number_format($totalIntereses,2)),1,0,'R');
$pdf->Cell(46,10,utf8_decode('$'.number_format($arreglo["pagoCadaPeriodo"][1]["deudaDespuesPago"],2)),1,0,'R');
$pdf->Cell(46,10,utf8_decode('$'.number_format($pagoFinalPeriodoTotal + $interesPeriodo + $montoNecesitado,2)),1,1,'R');
