$(document).ready(function(){
        ...
        function start(){
            ...
            else
            {
                ...
                let tamlogoIPN=document.getElementById('idLogoIPN');
                tamlogoIPN.innerHTML='<figure><img src="https://serviciosocialescom.herokuapp.com/assets/img/IPNBlancoyNegro.png" class="rensponsive-img"  alt="LogoIPN" style="width:100%"></figure>';
